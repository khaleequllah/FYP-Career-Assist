...
from .models import UniHec, Courses ,OnlineCourses , Institutions, VocationalInstitutions
from .serializers import UniHecSerializer, CoursesSerializer, OnlineCoursesSerializer, InstitutionsSerializer, VocationalInstitutionsSerializer, UserSerializer
