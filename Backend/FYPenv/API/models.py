...
class AuthUser(models.Model):
    ...
    # Interests1 = models.CharField(max_length=30)
    # Interests2 = models.CharField(max_length=30)
    # Interests3 = models.CharField(max_length=30)
...
class Courses(models.Model):
    ...
    duration = models.CharField(db_column='Duration', max_length=50, blank=True,
...
class UniHec(models.Model):
    ...
    website = models.CharField(db_column='Website', max_length=512,
                               db_collation='ascii_general_ci')  # Field name made lowercase.
