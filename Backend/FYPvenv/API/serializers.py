...
from .models import UniHec, Institutions,VocationalInstitutions, OnlineCourses ,Courses , UniCourses
...
class UniCoursesSerializer(serializers.ModelSerializer):
    class Meta:
        model = UniCourses
        fields = ('id', 'institute','city','duration','course','field')
